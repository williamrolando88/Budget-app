...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference("Operation.count") do
      post operations_url, params: { operation: { amount: @operation.amount, name: @operation.name, user_id: @operation.user_id } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { amount: @operation.amount, name: @operation.name, user_id: @operation.user_id } }
